...
const UpdateProgressCalendar = ({
  ...
  const currentMonthDates = dates.filter(dateVal => parseInt(dateVal.date.split('-')[1]) === currentMonthYear.month + 1);
  ...
  return (
    <NarrowContainer>
      <div className="flex items-center gap-4">
        ...
        <p className="w-30">{MONTH_DAYS[currentMonthYear.month].label}, {currentMonthYear.year }</p>
